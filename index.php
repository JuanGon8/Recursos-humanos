                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
								...
								<img class="logoindex" src="assets/img/svm_logo.png" alt="">
								<h3 class="text-center font-weight-light my-4">Bienvenido</h3>
                                    <div class="card-body">
                                        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Usuario</label><input class="form-control py-4" id="inputEmailAddress" name="usuario" type="text" placeholder="Ingresa el correo electrónico" /></div>
											...
											<button type="submit" class="btn btn-primary btn-block">Iniciar sesión</button></div>
										</form>
									</div>
